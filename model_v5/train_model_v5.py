...
DEFAULT_METRICS_PATH = str(Path(FAST_OUTPUT_ROOT) / "models" / "Model_V5_training_metrics.csv")
...
def make_checkpoint(
    ...
    return {
        ...
        "model_type": "bev_soft_reliability_model_v5",
        "epoch": epoch,
...
def main():
    parser = argparse.ArgumentParser(
        description="Train Model_V5 as a soft LiDAR reliability/unreliability estimator."
    )
